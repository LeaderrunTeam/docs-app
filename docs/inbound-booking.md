...
| warehouseCode         | 交仓仓库代码   | String(10)   | 对应立航仓库代码。[监管仓代码表](#监管仓库代码表)、[保税区仓库代码表](#保税区仓库代码表)                                                | N             |
...
| satWhseCode           | 卫星仓代码     | String(6)    | 用于判断卫星仓业务,以便卫星仓业务的流转运作.以下为立航目前现有的卫星仓已经对应 CODE. [卫星代码表](#卫星仓库代码表)                      | N             |
...
| packageUnit           | 包装单位       | String(30)   | 若没提供 PO,ITEM 明细,则必需提供包装单位。[包装单位](#包装单位代码表)                                                                   | Y             |
