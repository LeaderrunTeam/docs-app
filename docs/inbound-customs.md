...
| 1.0.5 | `vehicleList` 仓转成业务非必填 <br/> `outbdWarehouseName/outbdWarehouseCode` 设置非必填  <br/> 报关单回执状态`100`新增回传`invtNo/invtQd/manualNo/manualQd` | 赖钻   | 2026-06-10 |
...
| vehicleList   | 车辆信息           | [`List(1...n)`](#vehicle-params)    |   仓转仓业务没有车辆的情况下不必填，其它业务必填        |    O     |
...
| otherWrapTypes  | 其他包装单位代码               | `Set<String>`                        |          有多个包装单位在这里补充，需要排除`wrapType`                                                                                                                                 |    N     |
...
| **字段名称**       | **字段描述**   | **数据类型** | **详细说明**       | **必填** |
| ------------------ | -------------- | ------------ | ------------------ | :------: |
| outbdWarehouseName | 转出方企业名称 | String(70)   |                    |    N     |
| outbdWarehouseCode | 转出方海关编码 | String(10)   |                    |    N     |
...
| containerWeight    | 柜皮重         | Short        | 柜车必填                                    |    O     |
...
| invtNo         | 核注清单统一编号   | String(20)                | 状态码 50、55、100 必填    |    O     |
| invtQd         | 核注清单 QD 号     | String(20)                | 状态码 50、55、100 必填    |    O     |
| seqNo          | 统一编号           | String(20)                | 状态码 80、90、100 必填 |    O     |
| customsNo      | 报关单编号         | String(20)                | 状态码 80、90、100 必填 |    O     |
| manualNo       | 金二手账册统一编号 | String(20)                | 状态码 70 必填 ，加贸订单 100 状态也必填       |    O     |
| manualQd       | 金二手账册 QD 号   | String(20)                | 状态码 70 必填，加贸订单 100 状态也必填       |    O     |
